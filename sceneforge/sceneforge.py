...
/* Radix input focus ring — use our indigo */
...
/* Smooth focus transitions everywhere */
button, input, textarea, a {
    transition: box-shadow 0.2s ease;
}

/* Remove Reflex default button style resets that fight our styles */
.rt-reset.rt-BaseButton {
    font-family: inherit;
}

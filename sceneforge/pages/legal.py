...
def terms_page() -> rx.Component:
    terms_content = rx.vstack(
        rx.text("Welcome to SceneForge. By using our services, you agree to comply with and be bound by the following terms of service. Please review them carefully.", color="rgba(212,212,216,0.9)", font_size="0.92rem", line_height="1.6"),
        rx.heading("1. Acceptable Use", size="4", font_weight="700", color="#f4f4f5", margin_top="16px"),
        rx.text("You agree to use SceneForge only for lawful purposes related to film research. You may not upload malicious documents or attempt to exploit the service or database.", color="rgba(161,161,170,0.9)", font_size="0.88rem", line_height="1.6"),
        rx.heading("2. Intellectual Property", size="4", font_weight="700", color="#f4f4f5", margin_top="16px"),
        rx.text("The uploaded research documents are owned by their respective copyright holders. SceneForge processes the documents solely to provide retrieval-augmented answers to the uploading user.", color="rgba(161,161,170,0.9)", font_size="0.88rem", line_height="1.6"),
        rx.heading("3. AI Limitations", size="4", font_weight="700", color="#f4f4f5", margin_top="16px"),
        rx.text("While SceneForge incorporates zero-hallucination prompting and vector search, AI models may occasionally produce incomplete or inaccurate answers. Users should verify critical sources directly.", color="rgba(161,161,170,0.9)", font_size="0.88rem", line_height="1.6"),
...
def privacy_page() -> rx.Component:
    privacy_content = rx.vstack(
        rx.text("At SceneForge, we value your privacy. This policy outlines how we handle your personal data and uploaded documents.", color="rgba(212,212,216,0.9)", font_size="0.92rem", line_height="1.6"),
        ...
        rx.text("SceneForge uses secure, same-site cookies to maintain your login session. No cross-site tracking cookies are utilized.", color="rgba(161,161,170,0.9)", font_size="0.88rem", line_height="1.6"),
        spacing="4",
        align_items="start",
    )
    return rx.box(
